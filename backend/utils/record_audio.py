...
if __name__ == "__main__":
    ...
    parser.add_argument("filename", nargs="?", default="my_voice.wav", help="Output WAV file name (default: my_voice.wav)")
    parser.add_argument("-d", "--duration", type=int, default=5, help="Recording duration in seconds (default: 5)")
    parser.add_argument("-sr", "--samplerate", type=int, default=24000, help="Sample rate in Hz (default: 24000)")
